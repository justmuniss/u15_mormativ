...
from .views import product_list,category_products,category_list,contact_view,book_list,book_detail,book_create,book_update,book_delete,register_view,login_view,logout_view
